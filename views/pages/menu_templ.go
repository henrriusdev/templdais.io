...
func CodeMn() templ.Component {
	...
	Class: "bg-base-100",
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/pages/menu.templ`, Line: 91, Col: 4}
		}
...
templ MyComponent() {
	...
	// ...
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/pages/menu.templ`, Line: 115, Col: 3}
		}
